...
function OnboardingInner() {
  ...
  if (step === "welcome") {
    return (
      <main key={step} className="h-app max-w-md mx-auto flex flex-col px-6 pt-10 pb-[calc(2rem+env(safe-area-inset-bottom))] onb-step">
        <PhoneMockup />
  ...
  return (
    <main key={step} className="h-app max-w-md mx-auto flex flex-col justify-between px-6 pt-10 pb-[calc(2rem+env(safe-area-inset-bottom))] onb-step">
      <div>
        <button
          onClick={() => setStep("notifications")}
